...
async function updateCards() {
    try {
        ...
        cards.forEach(card => {
            ...
            const previousClass = card.reverse ? (card.improvement ? 'previous-decline' : 'previous-improvement') : (card.improvement ? 'previous-improvement' : 'previous-decline');
            ...
            cardElement.innerHTML = `
                ...
                <div class="flex items-center justify-between w-full mt-1">
                    ...
                    <p class="previous text-sm/[8px] font-normal ${previousClass}">${card.previous}</p>
                </div>`;
