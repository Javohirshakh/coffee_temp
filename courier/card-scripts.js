    ...
    try {
        ...
        const cards = [
            ...
            },
            {
                ...
                value: `${data.averageDeliveryTime.toFixed(2)} мин`,
                previous: `${data.pwAverageDeliveryTime.toFixed(2)} мин`,
        ...
        cards.forEach(card => {
            ...
            cardElement.innerHTML = `
                ...
                <div class="flex items-center justify-between w-full">
                    <p class="current text-base font-medium ">${card.value}</p>
                    <p class="previous text-xs font-normal ${card.improvement ? 'improvement' : 'decline'}">${card.previous}</p>
                </div>`;
